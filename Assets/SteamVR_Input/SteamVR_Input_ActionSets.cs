...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_NodeNavigation p_NodeNavigation;
        ...
        public static SteamVR_Input_ActionSet_NodeNavigation NodeNavigation
        {
            get
            {
                return SteamVR_Actions.p_NodeNavigation.GetCopy<SteamVR_Input_ActionSet_NodeNavigation>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_NodeNavigation = ((SteamVR_Input_ActionSet_NodeNavigation)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_NodeNavigation>("/actions/NodeNavigation")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.NodeNavigation};
        }
    }
}
